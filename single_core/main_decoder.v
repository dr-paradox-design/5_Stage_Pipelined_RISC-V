...
assign ALUSrc = (op == 7'b0000011) | (op == 7'b0010011) | (op == 7'b0100011) ? 1'b1 : 1'b0;    assign ResultSrc = (op == 7'b0000011) ? 1'b1 : 1'b0; //if op is 0000011 then ResultSrc=1 else ResultSrc=0
